  ...
  return (
    <motion.div
      ...
      <motion.img
        ...
        className="w-32 h-32 rounded-full border-4 border-[#00ffff] shadow-lg shadow-[#00ffff]/30 object-cover"
      />
      <motion.div
        ...
        <motion.p
          className="italic text-[#fd19fc] font-handwriting text-xl mt-4 max-w-md text-center"
