...
export default function PricingPage() {
  ...
  const packages = [
    ...
    },
    {
      ...
      priceEuro: t.webAppPrice,
      priceHuf: t.webAppPrice,
      color: "from-green-500 to-green-600",
      borderColor: "border-green-400",
      shadowColor: "shadow-green-500/20",
      hoverShadow: "hover:shadow-green-500/30",
      subtitle: t.webAppSubtitle,
      description: t.webAppDescription,
      features: t.webAppFeatures,
    },
    {
      id: "custom",
                            ...
                            {(pkg.id === "pro"
                              ...
                              <motion.li
                                ...
                                transition={{
                                  duration: 0.4,
                                  delay:
                                    0.7 + index * 0.1 + featureIndex * 0.05,
                                }}
                                viewport={{ once: true, margin: "-50px" }}>
                                <motion.span
                                  ...
                                  transition={{
                                    ...
                                    stiffness: 300,
                                    delay:
                                      0.8 + index * 0.1 + featureIndex * 0.05,
                                  }}
                                  viewport={{ once: true, margin: "-50px" }}>
                                  ✓
                                </motion.span>
