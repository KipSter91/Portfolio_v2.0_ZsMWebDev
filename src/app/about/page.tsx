      ...
      {!isExiting && isLoaded && (
        <motion.div
          ...
          <div className="w-full max-w-5xl relative">
            <motion.button
              className="absolute top-0 left-0 mb-6 bg-[#2C313A] text-white py-2 px-4 rounded hover:bg-[#fd19fc] transition-colors shadow-md"
              ...
              <div className="w-full bg-[#1E2228] p-6 md:p-8 rounded-xl shadow-xl border-t border-l border-gray-700 mb-8">
                <div className="flex flex-col md:flex-row gap-8 items-center md:items-start">
                  ...
                  <div className="md:w-2/3">
                    <h1 className="text-3xl md:text-4xl font-bold mb-4 md:mb-6 text-[#00ffff] text-center md:text-left">
                      {t.about}
                    </h1>
                ...
                <motion.div
                  ...
                  <div className="bg-[#2C313A] p-5 rounded-lg border-l border-t border-gray-700">
                    ...
                    <p className="text-gray-300">
                      Team leadership and warehouse management with parallel
                      development of web development skills and technological
                      innovations.
                    </p>
                  </div>
