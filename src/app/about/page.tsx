    ...
    <AnimatePresence mode="wait">
      {!isExiting && isLoaded && (
        <motion.div
          ...
          <div className="w-full max-w-5xl relative">            <motion.button
              className="absolute top-0 left-0 mb-6 bg-[#2C313A] text-white py-2 px-4 rounded hover:bg-[#fd19fc] transition-all duration-300 flex items-center gap-2 shadow-lg hover:shadow-[#fd19fc]/20 hover:-translate-x-1"
            ...
            <motion.div
              ...
              <div className="w-full bg-[#1E2228] p-6 md:p-8 rounded-xl shadow-xl border-t border-l border-gray-700 mb-8">
                <div className="flex flex-col md:flex-row gap-8 items-center md:items-start">
                  <div className="md:w-1/3 flex justify-center md:justify-start">                    <motion.div
                      ...
                      {/* Pulzáló nyíl a kép bal oldala felé */}                      <motion.div
                    ...
                    >
                      ...
                      <p className="text-lg leading-relaxed">
                        ...
                        artificial intelligence and AI tools. This
                        expertise enables me to combine technological
                        innovations with my leadership experience to offer
                        effective solutions to modern business challenges.
                      </p>
                  ...
                  animate={{ opacity: 1, y: 0 }}
                  transition={{ duration: 0.7, delay: 0.6, ease: "easeOut" }}>                  <div className="bg-[#2C313A] p-5 rounded-lg border-l border-t border-gray-700 hover:shadow-lg hover:shadow-[#fd19fc]/10 hover:-translate-y-1 transition-all duration-300">
